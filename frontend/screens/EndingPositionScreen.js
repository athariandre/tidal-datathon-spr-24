...
export function EndPosScreen({ navigation, route }) {
  const { startCity, startPos, startId } = route.params;
  ...
  >
    <SafeAreaView style={styles.container}>
      <Text style={styles.label}>Ending City:</Text>
      <View style={styles.autocompleteContainer}>
        <GooglePlacesAutocomplete
          fetchDetails={true}
          placeholder='Search'
          onPress={async (data, details = null) => {
            setEndCity(data.description);
            setEndId(data.place_id);
            setEndPos(details?.geometry?.location);
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate("LatestTime", {startCity, startPos, startId, endCity, endPos, endId})}
          disabled={!startCity}
        >
